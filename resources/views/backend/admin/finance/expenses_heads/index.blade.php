...
@section('content')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                    ...
                    serverSide: true,
                    pageLength: 50,
                    ajax: "{{ route('admin.expenses-heads.index') }}",
                    columns: [
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data_sm").empty();
            $('.modal-title').text('Add New Expenses Head'); // Set Title to Bootstrap modal title

            $.ajax({
                type: 'GET',
                url: 'expenses-heads/create',
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#manage_all").on("click", ".delete", function () {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Deleting of a expenses head!!",
                    type: "warning",
