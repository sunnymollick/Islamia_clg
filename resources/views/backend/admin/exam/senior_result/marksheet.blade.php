        ...
        <div class="row" id="header_details">
            <div class="col-md-12 col-sm-12" style="margin-bottom: -18px;">
                <p style="text-align: center">
                    <img style="border: none;" src="{{ asset('assets/images/logo/islamia_clg_logo.jpg') }}"
            ...
            <div class="col-md-8 col-sm-12 table-responsive">
                <table id="std_inf" class="table table-bordered" cellspacing="2px">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><img style="border: none;" src="{{ asset('assets/images/pricipal_signature.png') }}" class="img-responsive img-thumbnail" width="50px"/>
                        </td>
                    </tr>
                </table>
            </div>
