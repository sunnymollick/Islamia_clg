            ...
            @foreach($data['result'] as $row)
                @php
                    ...
                    if ($row->result == 'PASSED') {
                        ...
                        $pass = $pass + 1;
                        $status = '<span class="bg bg-success">PASSED</span>';

                    } else {
                        $gpa = "F";
                        $cgpa = '0.00';
                        $fail = $fail + 1;
                        $failedSubject = $row->failedSubject;
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a data-toggle='tooltip' title='View Tabulation Sheet'
                            class="btn btn-success view" std_roll="{{ $row->stdRoll }}"
                            std_name="{{ $row->stdName }}"
                            std_code="{{ $row->stdCode }}"> View MarkSheet
                        </a>
                    </td>
                    <td class="text-center">
                        <a data-toggle='tooltip' title='View Transcript'
                            class="btn btn-warning viewTranscript" std_roll="{{ $row->stdRoll }}"
                            std_name="{{ $row->stdName }}"
                            std_code="{{ $row->stdCode }}"> View Transcript
                        </a>
                    </td>
                </tr>
...
<script>
    $("#loaderSubmit").hide();
    $("#manage_all").on("click",".viewTranscript",function(){
        $("#modal_data").empty();
        $(".modal-title").text("Transcript");
