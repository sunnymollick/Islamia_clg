...
@section('content')
                ...
                <div class="box-header with-border">
                    <p class="panel-title"> All Applications
                        @can('online-application-create')
                            ...
                            <button id="export_pdf" class="btn btn-warning" onclick="exportStudent('PDF')"><i
                                    class="fa fa-file-pdf fa-fw"></i>
                                PDF Export
                            </button>
                        @endcan
                    </p>
                        ...
                        <div class="col-md-12 col-sm-12 table-responsive">
                            <table id="manage_all" class="table table-collapse table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>Optional Subject Name</th>
                                    <th>Optional Subject Code</th>
                                    <th>Mobile</th>
                                    <th>Picture</th>
                                    <th>Action</th>
                                </tr>
        ...
        $(document).ready(function () {
            ...
            table = $('#manage_all').DataTable({
                ...
                columns: [
                    ...
                    {data: 'college_roll', name: 'college_roll'},
                    ...
                    {data: 'admitted_section', name: 'admitted_section'},
                    {data: 'optional_subject_name', name: 'optional_subject_name'},
                    {data: 'optional_subject_code', name: 'optional_subject_code'},
    ...
    <script>
        function exportStudent(val) {
            ...
            var url = 'exportAdmissionStudentPdf/';
        ...
        $(document).ready(function () {
            $("#manage_all").on("click", ".delete", function () {
                ...
                swal({
                    ...
                    text: "Deactive data can be recovered again!!",
                    type: "warning",
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: true,
                    ...
                    $.ajax({
                        url: 'admissionApplicationSoftDelete/' + id,
                        type: 'get',
                        dataType: 'json',
                        success: function (data) {
