    ...
    <div class="col-md-12">
        <table class="table table-hover table-bordered">
            <tr>
                ...
                <td> {{'Class  : ' . $admissionApplication->admitted_class . ', Section : ' . $admissionApplication->admitted_section}}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    Exam Roll : {{$admissionApplication->ssc_exam_roll}} ,
                    Registration No. : {{$admissionApplication->ssc_reg_no}} <br/>
                    Board : {{$admissionApplication->ssc_exam_board}} ,
                    Session : {{$admissionApplication->ssc_exam_session}} ,
                    Passed Year : {{$admissionApplication->ssc_passed_year}} <br/>
                </td>
            </tr>
            <tr>
