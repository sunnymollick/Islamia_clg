    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-header with-border">
                <p class="panel-title"> Attendance
                    <a style="color: #fff"
                        href="{{ asset('assets/documents/attendance_teacher_demo.xlsx') }}"
                        class="btn btn-danger">Demo Attendance Excel File
                    </a>
                </p>
            </div>
        <form id='create' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    <label for="excel_upload">Import Teacher Attendance</label>
