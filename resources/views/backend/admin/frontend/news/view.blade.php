    ...
    <div class="col-md-12 col-sm-12 table-responsive">
        <table id="view_details" class="table table-bordered table-hover">
            ...
            <tr>
                <td> Image</td>
                <td> :</td>
                <td><img src="{{ asset($news->file_path) }}" class="img-responsive img-thumbnail" width="200px"></td>
            </tr>
            <tr>
                <td> Document</td>
                <td> :</td>
                <td><a href="{{ asset($news->document) }}" class="btn btn-success" download>Download</a></td>
            </tr>
            </tbody>
        </table>
    </div>
