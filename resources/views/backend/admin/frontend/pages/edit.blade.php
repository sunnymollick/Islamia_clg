<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="form-group col-md-12 col-sm-12">
        ...
        <textarea type="text" class="form-control" id="summery" name="summery"
                  placeholder="">{{ $page->summery }}</textarea>
        <span id="error_summery" class="has-error"></span>
    </div>
    <div class="clearfix"></div>
    <div class="form-group col-md-3">
        <label for=""> Status </label><br/>
        <input type="radio" name="status" class="flat-green"
               value="1" {{ ( $page->status == 1 ) ? 'checked' : '' }} /> Active
        <input type="radio" name="status" class="flat-green"
               value="0" {{ ( $page->status == 0 ) ? 'checked' : '' }}/> In Active
    </div>
    <div class="col-md-7">
