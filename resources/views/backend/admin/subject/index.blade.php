    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#manage_all").on("click", ".view", function () {
                var id = $(this).attr('id');
                ajax_submit_view('subjects', id)
            });

            // Edit Form
            $("#manage_all").on("click", ".edit", function () {
                var id = $(this).attr('id');
                ajax_submit_edit('subjects', id)
            });
            ...
            $("#manage_all").on("click", ".delete", function () {
                var id = $(this).attr('id');
                ajax_submit_delete('subjects', id)
            });
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <div class="form-group col-xl-4 col-lg-2 col-md-3 col-sm-12 mb-3 mb-lg-0">
