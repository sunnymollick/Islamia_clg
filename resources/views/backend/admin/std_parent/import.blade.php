    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>All Parents Import</div>
                <div class="ml-2">
                    {{-- @can('teacher-import') --}}

                        <a style="color: #fff" href="{{ asset('assets/documents/parent.xlsx') }}"
                           class="btn btn-danger">Demo Parents Excel File</a>
            ...
            $('#create').validate({// <- attach '.validate()' to your form
                ...
                submitHandler: function (form) {
                    ...
                    swal({
                        ...
                        $.ajax({
                            url: '{!! route('admin.importStdParents.import') !!}',
                            type: 'POST',
                            data: myData,
                            dataType: 'json',
                            cache: false,
