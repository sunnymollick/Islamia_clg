<div class="app-footer">
    <div class="col-12 text-center rounded-top"
        ...
        Developed by W3xplorers Bangladesh || &nbsp; {{date('Y')}}
    </div>
</div>
    ...
    <!-- drop-down-menu -->
    <!-- <link rel="stylesheet" href="{{ asset('/assets/plugins/drop-down-menu/vgnav.css') }}">
    <link rel="stylesheet" href="{{ asset('/assets/plugins/drop-down-menu/vgnav-theme.css') }}">
    <script src="{{ asset('/assets/plugins/dist/vgnav.umd.js') }}"></script> -->
