<div class="app-header">
    <div class="app-header__logo">
        <div class="logo-src"><h4 style="text-align:left;font-weight: bold;line-height:20px;">AdminPanel</h4></div>
    ...
    @php
        $session = DB::table('settings')->first();
    @endphp
        ...
        <div>
            <h6>
                <span class="text-danger" style="float: left;">
                    <b>
                      *  Running Session : {{ $app_settings->running_year }}
                    </b>
                </span>
            </h6>
        </div>
