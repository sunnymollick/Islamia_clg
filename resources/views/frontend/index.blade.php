                                        ...
                                        @foreach($teachers_notice as $tn)
                                            <div class="rp-item">
                                                <img class="rp-thumb set-bg"
                                                    src="{{ asset('assets/frontend/images/blog/notice.png') }}"/>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ URL :: to('/onlineAdmission') }}"><img
                                            src="{{ asset('assets/frontend/images/online-admission.jpg') }}"
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ URL :: to('/prospectus') }}"><img
                                src="{{ asset('assets/frontend/images/prospectus.jpg') }}"
                                class="img-thumbnail"
                                alt=""/></a><br/>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ URL :: to('/academicCalender') }}"><img
                                src="{{ asset('assets/frontend/images/calender.jpg') }}"
                                class="img-thumbnail"
                                alt=""/></a><br/>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ URL :: to('/classRoutine') }}"><img
                                src="{{ asset('assets/frontend/images/routine.jpg') }}"
                                class="img-thumbnail"
                                alt=""/></a><br/>
                    </div>
                </div>
