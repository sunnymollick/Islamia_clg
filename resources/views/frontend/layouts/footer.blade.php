...
<script src="{{ asset('assets/frontend/js/jquery.plainoverlay.min.js') }}"></script>
<!-- SlimScroll -->
...
<script src="{{ asset('assets/frontend/js/jquery.printElement.min.js') }}"></script>
<!-- Datepicker library -->
<link rel="stylesheet" href="{{ asset('/assets/frontend/plugins/datepicker/datepicker3.css') }}">
<script src="{{ asset('/assets/frontend/plugins/datepicker/bootstrap-datepicker.js') }}"></script>
