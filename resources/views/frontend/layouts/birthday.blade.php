<!-- Hero section -->
@if($birthday->count()>0)
    <section class="fact-section spad set-bg" data-setbg="{{ asset('assets/frontend/images/birthday.jpg') }}">
        <div class="container">
            <div id="snow"></div>
            <div class="row">
    ...
    <!-- Hero section end -->
    <link rel="stylesheet" href="{{ asset('/assets/frontend/css/birthday_snow.css') }}">
    <script src="{{ asset('assets/frontend/js/birthday_snow.js') }}"></script>
@endif
