    ...
    public function allPages()
    {
        ...
        return Datatables::of($pages)
            ->addColumn('status', function ($page) {
                return $page->status ? '<span class="badge badge-success">Active</span>' : '<span class="label label-danger">Inactive</span>';
            })
            ->addColumn('action', function ($page) use ($can_edit, $can_delete) {
                ...
                $html .= '<a data-toggle="tooltip" ' . $can_edit . '  id="' . $page->id . '" class="btn btn-xs btn-warning margin-r-5 edit" title="Edit"><i class="fa fa-edit fa-fw"></i> </a>';
                $html .= '<a data-toggle="tooltip" ' . $can_delete . '  id="' . $page->id . '" class="btn btn-xs btn-danger margin-r-5 delete" title="Delete"><i class="fa fa-trash fa-fw"></i> </a>';
                $html .= '</div>';
                return $html;
            })
